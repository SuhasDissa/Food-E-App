...
fun ProductNotFoundScreen(
    ...
    Column(
        ...
        Text(
            stringResource(id = R.string.product_not_found),
        ...
        Box(
            ...
            Image(
                ...
                painter = painterResource(id = R.drawable.egg_not_found_icon),
...
private fun ProductNotFoundScreenPreview() {
    ProductNotFoundScreen("03985096362")
}
